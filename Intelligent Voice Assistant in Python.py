...
def open_app(text):
    ...
    if (app == 'notepad'):
        resource = r"C:\Windows\WinSxS\wow64_microsoft-windows-notepad_31bf3856ad364e35_10.0.22000.1_none_cfb2d573a92990de\notepad.exe"
            ...
            for i in range(0, len(textWords)):
                if (textWords[i].lower() == 'search'):
                    if (textWords[i + 1].lower() == 'for' or textWords[i + 1].lower() == 'about'):
                        website = 'https://www.google.co.in/webhp?tab=rw' + textWords[i + 2].lower()
                        break
                    else:
                        website = 'https://www.google.co.in/webhp?tab=rw' + textWords[i + 1].lower()
                        break
...
photo = PhotoImage(file=r"C:\Users\srini\OneDrive\Desktop\download.png")
photoimage = photo.subsample(1, 1)

photo1 = PhotoImage(file=r"C:\Users\srini\OneDrive\Desktop\download.png")
